...
a1 = Appointment.create(client_id: c1.id, professional_id: p1.id, date_created: DateTime.strptime("09/11/2019 17:00", "%m/%d/%Y %H:%M"), appt_date: DateTime.strptime("09/21/2019 15:00", "%m/%d/%Y %H:%M"), appt_time:  1200, duration: s1.duration, service: s1.service_name)
a2 = Appointment.create(client_id: c2.id, professional_id: p2.id, date_created: DateTime.strptime("09/12/2019 17:00", "%m/%d/%Y %H:%M"), appt_date: DateTime.strptime("09/22/2019 12:00", "%m/%d/%Y %H:%M"), appt_time:  1300, duration: s2.duration, service: s2.service_name)
a3 = Appointment.create(client_id: c1.id, professional_id: p2.id, date_created: DateTime.strptime("09/13/2019 17:00", "%m/%d/%Y %H:%M"), appt_date: DateTime.strptime("09/23/2019 1:00", "%m/%d/%Y %H:%M"), appt_time:  1500, duration: s3.duration, service: s3.service_name)
a4 = Appointment.create(client_id: c2.id, professional_id: p1.id, date_created: DateTime.strptime("09/14/2019 17:00", "%m/%d/%Y %H:%M"), appt_date: DateTime.strptime("09/24/2019 18:00", "%m/%d/%Y %H:%M"), appt_time:  1100, duration: s4.duration, service: s4.service_name)
