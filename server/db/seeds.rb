...
s9 = Service.create(professional_id: p1.id, service_name: "Haircut w/Facial Trim", price: 30, description: 'Haircut and facial hair will be trimmed', duration: '1 hour' )
s10 = Service.create(professional_id: p2.id, service_name: "Haircut and Facial Hair w/ Razor", price: 40, description: 'Haircut with soothing hot steam towel to give that fresh shave feeling', duration: '1 hour' )
s11 = Service.create(professional_id: p3.id, service_name: "Edge-up", price: 15, description: 'Edge the perimeter of your hair w/ razor', duration: '1 hour' )
s12 = Service.create(professional_id: p4.id, service_name: "Kids Haircut", price: 15, description: '12 and under', duration: '1 hour' )
s13 = Service.create(professional_id: p5.id, service_name: "Teen Cut", price: 20, description: 'Over 12 years old', duration: '1 hour' )
s14 = Service.create(professional_id: p6.id, service_name: "Hairwash", price: 10, description: 'Wash and condition hair', duration: '1 hour' )
s15 = Service.create(professional_id: p7.id, service_name: "Jus' a Cut", price: 25, description: 'Haircut with razor edge-up. Facial hair will not be touched', duration: '1 hour' )
s16 = Service.create(professional_id: p8.id, service_name: "Haircut w/Facial Trim", price: 30, description: 'Haircut and facial hair will be trimmed', duration: '1 hour' )
s17 = Service.create(professional_id: p1.id, service_name: "Haircut and Facial Hair w/ Razor", price: 40, description: 'Haircut with soothing hot steam towel to give that fresh shave feeling', duration: '1 hour' )
s18 = Service.create(professional_id: p2.id, service_name: "Edge-up", price: 15, description: 'Edge the perimeter of your hair w/ razor', duration: '1 hour' )
s19 = Service.create(professional_id: p3.id, service_name: "Kids Haircut", price: 15, description: '12 and under', duration: '1 hour' )
s20 = Service.create(professional_id: p4.id, service_name: "Teen Cut", price: 20, description: 'Over 12 years old', duration: '1 hour' )
