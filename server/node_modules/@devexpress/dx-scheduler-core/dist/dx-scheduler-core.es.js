...
var expandRecurrenceAppointment = function (appointment, leftBound, rightBound) {
    ...
    var options = __assign(__assign({}, RRule.parseString(appointment.rRule)), { dtstart: new Date(getUTCDate(appointmentStartDate)) });
